...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.63-kirby-problem-3.63-5f549e26-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.63"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.63-kirby-problem-3.63-5f549e26-v1",
      "problem_contract_sha256": "493eb786befd82c088006fd407ae8cdb2a922fe032325980dc7ad7931e74c00b",
      "problem_id": "problem:um-kp-3.63-kirby-problem-3.63-5f549e26",
      "route_id": "route:um-kp-3.63-kirby-problem-3.63-5f549e26-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.63-kirby-problem-3.63-5f549e26-source-fidelity-01",
      "graph_id": "graph:um-kp-3.63-kirby-problem-3.63-5f549e26-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.63-kirby-problem-3.63-5f549e26-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.63-kirby-problem-3.63-5f549e26-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Give a method for computing the $\\eta$ invariant for the Dirac operator, $\\eta_{\\mathrm{Dirac}}(Y, s)$, associated to a spin structure s on a hyperbolic 3-manifold Y."
          },
          "statement_sha256": "f721ea669a8e06cdbbd494ccd79fb286d13ee9cacab3548dc48371f167307ac6"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.63-kirby-problem-3.63-5f549e26-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.63-kirby-problem-3.63-5f549e26-root",
      "route_id": "route:um-kp-3.63-kirby-problem-3.63-5f549e26-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.63-b69b75271d24",
        "url": "https://www.unsolvedmath.com/problems/KP-3.63"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
